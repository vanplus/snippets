...
# 确定最新的 release 页面
latest_release_url=$(curl -sI https://github.com/aristocratos/btop/releases/latest | grep -i location | awk '{print $2}' | tr -d '\r')
...
# 下载文件
curl -L $download_url -o btop-x86_64-linux-musl.tbz
